...
const translations = {
    id: {
        ...
        heroDescription: 'Dengan pengalaman lebih dari 5 tahun sebagai IT Support yang berfokus pada hardware support, software support dan network administration. Juga aktif sebagai freelance web developer dengan keahlian HTML, CSS, JavaScript, PHP dan Laravel untuk membangun website yang fungsional dan modern.',
    ...
    en: {
        ...
        heroName: 'Irfan Riyanto',
        heroTitle: 'IT Support Professional & Freelance Web Developer',
        heroDescription: 'With over 5 years of experience as an IT Support professional focusing on hardware support, software support, and network administration. Also active as a freelance web developer with expertise in HTML, CSS, JavaScript, PHP and Laravel to build functional and modern websites.',
